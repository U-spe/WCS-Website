...
export default async function handler(req, res) {
  ...
  const systemInstructions = `
    ...
    2. Your response must be a valid JSON object containing a "sections" array. Do NOT wrap the response in markdown blocks. Output NOTHING but valid JSON.
  ...
  try {
    ...
    // Safely extract the array from the JSON object
